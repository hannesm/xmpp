...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2f79c5731df07fd78ba5319b6f650d23) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("digestif", None);
                           FindlibPackage ("mirage-crypto", None);
                           FindlibPackage ("mirage-crypto-rng", None);
                           FindlibPackage
                             ("base64",
     ...
     oasis_digest = Some "\196U\001\243Q\r\238\132\164>\024\221&\148\014x";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
